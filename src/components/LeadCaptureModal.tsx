              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Tailored automation roadmap for your specific business needs</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Clear projections on productivity gains and cost savings</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Step-by-step guide to deploying upskilling agents</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-center">
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100 mb-6">
                    <h4 className="text-xl font-bold text-gray-900 mb-2">Free 30-Minute Consultation</h4>
                    <p className="text-gray-600 mb-4">No commitment required. Discover how we can transform your business.</p>
