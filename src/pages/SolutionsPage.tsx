...
export const SolutionsPage: React.FC<SolutionsPageProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden scroll-smooth">
      {/* Header: Solutions variant (Back to Home + Demo) */}
      <SiteHeader variant="solutions" onDemoClick={onOpenModal} onBackToHome={onBackToHome} />
      ...
      {/* Floating blobs */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-emerald-500/20 rounded-full blur-xl animate-pulse duration-4000" />
      <div className="absolute top-40 right-20 w-32 h-32 bg-blue-500/20 rounded-full blur-xl animate-pulse delay-1000 duration-4000" />
      <div className="absolute bottom-40 left-20 w-24 h-24 bg-purple-500/20 rounded-full blur-xl animate-pulse delay-2000 duration-4000" />

      {/* Hero (padding matches Home header height) */}
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 md:pt-28">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mb-16 animate-slide-up delay-400">
            <button
              onClick={() => {
                const el = document.getElementById("solutions-portfolio");
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-blue-400 rounded-xl opacity-0 group-hover:opacity-20 transition-opacity duration-300" />
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-stagger-in">
            ...
            <div className="group bg-gradient-to-br from-orange-50 to-red-50 p-8 rounded-2xl border border-orange-100 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-500 hover:-translate-y-2 hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Optimize and enhance your business processes through intelligent
                analysis and strategic improvements that maximize efficiency and
                performance.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
            ...
            <div className="group bg-gradient-to-br from-rose-50 to-pink-50 p-8 rounded-2xl border border-rose-100 hover:shadow-xl hover:shadow-rose-500/10 transition-all duration-500 hover:-translate-y-2 hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Foster innovation culture and accelerate idea-to-implementation
                cycles with AI-powered innovation management that transforms
                creative concepts into business value.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
            ...
            <div className="group bg-gradient-to-br from-teal-50 to-cyan-50 p-8 rounded-2xl border border-teal-100 hover:shadow-xl hover:shadow-teal-500/10 transition-all duration-500 hover:-translate-y-2 hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Transform your business strategy with AI-powered insights and
                expert guidance that aligns technology initiatives with
            ...
            <div className="group bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-2xl border border-indigo-100 hover:shadow-xl hover:shadow-indigo-500/10 transition-all duration-500 hover:-translate-y-2 hover:scale-105">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Navigate organizational transformation with AI-powered change
                management that ensures smooth transitions and employee
                adoption.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
      ...
      <section className="relative z-10 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 py-20 px-4 sm:px-6 lg:px-8 transition-all duration-500">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
              Our solutions work seamlessly together to create a unified,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-stagger-in">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-500">
              ...
              <p className="text-emerald-100 leading-relaxed text-sm">
                All solutions share a common data foundation, ensuring
                consistency and enabling powerful cross-functional insights.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-500">
              ...
              <p className="text-blue-100 leading-relaxed text-sm">
                Solutions integrate effortlessly with your existing systems and
      ...
      {/* CTA */}
      <section className="relative z-10 bg-gradient-to-br from-emerald-50 to-blue-50 py-20 px-4 sm:px-6 lg:px-8 transition-all duration-500">
      ...
      {/* Footer */}
      <footer className="bg-slate-900 border-t border-gray-800 py-8 px-4 sm:px-6 lg:px-8">
...
// keep both named and default export to avoid import breakages elsewhere
