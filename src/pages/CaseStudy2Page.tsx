  ...
  <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 min-h-screen font-sans">
    ...
    <main className="max-w-4xl mx-auto py-20 px-4 text-left">
      <h1 className="text-4xl font-bold text-blue-400 mb-8">
        Digital Human Resources Transformation in a Global Professional Services
        Network
      </h1>
        ...
        <tbody>
          ...
          <tr>
            <td className="px-4 py-2 bg-blue-800">
              <ul className="list-disc pl-5">
                <li>
                  Delivered personalized, context-specific prompts that improved
                  client engagement during workshops.
                </li>
              </ul>
            </td>
          </tr>
