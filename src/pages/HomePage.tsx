  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden scroll-smooth">
      ...
      <HeroVortex
        ...
        baseHue={220}
        className="min-h-screen px-4 sm:px-6 lg:px-8 lg:flex lg:items-center lg:justify-center"
      >
        <div className="max-w-5xl mx-auto text-center pt-16 pb-20 sm:pt-20 sm:pb-24">
          {/* Badge */}
