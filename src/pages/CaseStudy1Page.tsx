...
export const CaseStudy1Page = ({ onBackToHome }) => (
    ...
    <main className="max-w-4xl mx-auto py-20 px-4 text-left">
      ...
      <ul className="list-disc pl-6 text-blue-100 mb-4">
        <li>
          ...
          knowledge databases and third-party data. Prompt engineering was a
          manual, inconsistent, and heavily dependent on individual expertise -
          causing delays and variable quality. <sup>1</sup>
        </li>
      </ul>
      ...
      <p className="text-lg text-blue-100 mb-4">
        ...
        relevance, and workflow agents that could autonomously re-route prompts
        based on response quality. <sup>3</sup>
      </p>
      ...
      <ul className="min-w-full bg-white rounded-lg shadow my-8 list-disc pl-6 text-blue-900">
        ...
        <li>
          Upskilling curve lowered: new hires reached full productivity in half
          the time.
        </li>
        <li>
      ...
      <p className="text-lg text-blue-100 mb-4">
        ...
        storytelling, hypothesis testing, and client engagement.<sup>4</sup>4
      </p>
